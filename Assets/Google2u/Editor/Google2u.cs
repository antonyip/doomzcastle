...
namespace Google2u
{
    ...
    public partial class Google2u : EditorWindow
    {
        ...
        private void Init()
        {
            ...
            RefreshTimeout = DateTime.ParseExact(Google2uGUIUtil.GetString("RefreshTimeout", RefreshTimeout.ToString("O")), "O", CultureInfo.InvariantCulture);
        ...
        static void AddManualWorkbookByUrl(string in_manualUrl, Google2uData in_instance)
        {
            ...
            try
            {
                ...
                if (feed != null)
                {
                    ...
                    if (info == null)
                    {
                        var newWorkbook = new Google2uManualWorkbook(feed, finalUrl, feed.Title.Text, in_instance.ManualService);
