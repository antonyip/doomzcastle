...
namespace Google2u
{
    ...
    public class Google2uCell
    {
                ...
                case SupportedType.BoolArray:
                    {
                        ...
                        foreach (var s in split)
                        {
                            ...
                            {
                                Tooltip = "Unable to convert " + CellValueString + " To Bool Array. You must use TRUE or FALSE";
                                return false;
                            }
                        }
                    }
                ...
                case SupportedType.Vector2Array:
                    {
                        ...
                        foreach (var s in split)
                        {
                            try
                            {
                                var innerdelims = in_base.ExportOptions.DelimiterOptions[in_base.ExportOptions.ComplexTypeDelimiters];
        ...
        private bool ValidateColumnHeader(List<Google2uRow> in_cells)
        {
            ...
            var duplicates = (from cell in in_cells[0].Cells where (MyCell.Value.Equals(cell.CellValueString) &&
        ...
        private bool ValidateRowHeader(List<Google2uRow> in_cells)
        {
            ...
            var duplicates = (from row in in_cells where (row[0].CellValueString.Equals(CellValueString) &&
        ...
        public static bool ContainsInvalidChars(string in_string)
        {
            ...
            return !in_string.Any(in_c => in_c.Equals('_') == false && char.IsLetter(in_c) == false && char.IsDigit(in_c) == false);
        }
