...
namespace Google2u
{
    public class EditorGUILayoutEx
    {
        ...
        public void LoadIcons()
        {
            ...
            HideButton = (Texture2D)Resources.Load("Google2u_hide", typeof(Texture2D));
            UploadButton = (Texture2D)Resources.Load("Google2u_upload", typeof(Texture2D));
            GoogleAuthButton = (Texture2D)Resources.Load("Google2u_signin", typeof(Texture2D));
            ...
            ClearButton = (Texture2D)Resources.Load("Google2u_clear", typeof(Texture2D));
        ...
        public FadeArea BeginFadeArea(bool in_open, string in_label, string in_id, GUIStyle in_areaStyle, GUIStyle in_labelStyle, string in_WorkbookVisibilityString)
        {
            var tmp1 = GUI.color;
