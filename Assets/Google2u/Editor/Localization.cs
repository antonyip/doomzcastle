...
namespace Google2u
{
	...
	public sealed class Localization : IGoogle2uDB
	{
		public enum rowIds {
			...
			, ID_LABEL_CULL_ROWS, ID_LABEL_ESCAPE_LINE_BREAKS, ID_LABEL_LEGACY_OPTIONS, ID_LABEL_LOWERCASE_HEADER
		};
		...
		private Localization()
		{
			...
			Rows.Add( new LocalizationRow("ID_MESSAGE_LOGGED_IN_AS", "Logged In", "Connecté", "Connesso", "Eingeloggt", "Conectado", "تسجيل الدخول", "在记录", "ログインしているユーザー", "로그인", "Logged In", "Записан В", "Ingelogd"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_DELETE", "Delete", "Effacer", "Cancellare", "Löschen", "Borrar", "حذف", "删除", "削除", "삭제", "Xóa bỏ", "Удалять", "Verwijder"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_LOGIN", "Log In", "S'identifier", "Login", "Einloggen", "Iniciar Sesión", "تسجيل الدخول", "登录", "ログイン", "에 로그인", "Đăng Nhập", "Войти", "Log In"));
			Rows.Add( new LocalizationRow("ID_LABEL_LOGOUT", "Log Out", "Se Déconnecter", "Uscire", "Abmelden", "Cerrar Sesión", "خروج", "注销", "ログアウト", "로그 아웃", "Đăng Xuất", "Выйти", "Uitloggen"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_AUTO_LOGIN", "Auto Login", "Connexion Automatique", "Auto Login", "Auto Login", "Ingreso Automático", "دخول السيارات", "自动登录", "自動ログイン", "자동 로그인", "Tự động đăng nhập", "Авто Войти", "Auto Login"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_ENABLE", "Enable", "Permettre", "Permettere", "Ermöglichen", "Permitir", "تمكين", "启用", "有効にします", "사용", "Cho phép", "Включить", "In staat stellen"));
			...
			Rows.Add( new LocalizationRow("ID_LABEL_UPDATE", "Update", "Mettre à jour", "Aggiornare", "Aktualisierung", "Actualización", "التحديث", "更新", "アップデート", "업데이트", "Cập nhật", "Обновление", "Bijwerken"));
