...
namespace Google2u
{
	...
	public sealed class Levels : IGoogle2uDB
	{
		...
		private Levels()
		{
			...
			Rows.Add( new LevelsRow("level9", "9", "helloworld", "0000000020004000000000060000000010000000000000003", "49", "unwritten"));
			Rows.Add( new LevelsRow("level10", "10", "a", "0006000002000400000000000000000010000000300000000", "49", "unwritten"));
			Rows.Add( new LevelsRow("level11", "11", "b", "0006001002000400000010000000000010000000300000100", "49", "unwritten"));
			Rows.Add( new LevelsRow("level12", "12", "c", "0000000020004000000000060000000010000000000000003", "49", "unwritten"));
			Rows.Add( new LevelsRow("level13", "13", "d", "0000000020004000000000060000000010000000000000003", "49", "unwritten"));
			Rows.Add( new LevelsRow("level14", "14", "e", "0000000020004000000000060000000010000000000000003", "49", "unwritten"));
			Rows.Add( new LevelsRow("level15", "15", "f", "0000000020004000000000060000000010000000000000003", "49", "unwritten"));
			Rows.Add( new LevelsRow("level16", "16", "g", "0000000020004000000000060000000010000000000000003", "49", "unwritten"));
		}
